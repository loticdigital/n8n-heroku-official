...
export DB_POSTGRESDB_HOST=$N8N_DB_HOST_V2
export DB_POSTGRESDB_PORT=$N8N_DB_PORT_V2
export DB_POSTGRESDB_DATABASE=$N8N_DB_DATABASE_V2
export DB_POSTGRESDB_USER=$N8N_DB_USER_V2
export DB_POSTGRESDB_PASSWORD=$N8N_DB_PASSWORD_V2
